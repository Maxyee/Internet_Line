...
class PostController extends Controller
{
	...
	//all post show here
     ...
     public function store(Request $request)
     {
		   ...
		   $data['firstpackage']=$request->firstpackage;
		   $data['seconpackage']=$request->seconpackage;
		   $data['thirdpackage']=$request->thirdpackage;
		   $data['fourpackage']=$request->fourpackage;
		   $data['fifthpackage']=$request->fifthpackage;
		   $data['sixpackage']=$request->sixpackage;
		   $data['seventhpackage']=$request->seventhpackage;
		   $data['eightpackage']=$request->eightpackage;
		   $data['ninthpackage']=$request->ninthpackage;
		   $data['tenthpackage']=$request->tenthpackage;
           ...
           if ($image) {
                ...
                Image::make($image)->resize(2000,2000)->save('public/postimages/'.$image_one);    //   public/postimages/123123.jpg
