...
//important website
    ...
    public function UpdateWebsite(Request $request,$id)
    {
		   ...
		   $data['baner1short_text']=$request->baner1short_text;
		   $data['baner2short_text']=$request->baner2short_text;
		   $data['baner3short_text']=$request->baner3short_text;
		   $data['footer_description']=$request->footer_description;
		   $data['app_download']=$request->app_download;
		   $data['apply_link']=$request->apply_link;
		   $data['tarif_link']=$request->tarif_link;
		   $data['ftp_link']=$request->ftp_link;
		   $data['about_video_link']=$request->about_video_link;
		   		   $data['counter1']=$request->counter1;
		   $data['counter2']=$request->counter2;
		   $data['counter3']=$request->counter3;
		   		   $data['counter4']=$request->counter4;
		   $data['counter5']=$request->counter5;
		   $data['counter6']=$request->counter6;
		   $data['live_tv']=$request->live_tv;
           $image=$request->logo;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(200,61)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
           ...
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(600,340)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
           ...
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(1640,624)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['package_image']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
		   ...
		   $image=$request->president_images;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(247,204)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['president_images']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
		   ...
		   $image=$request->genarelsecretr_images;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(247,204)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['genarelsecretr_images']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
           ...
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(719,323)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
		   ...
		   $image=$request->reason1;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(1920,1080)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['reason1']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
            ...
            return Redirect()->back()->with($notification);
		   		   ...
		   		   $image=$request->reason2;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(1920,1080)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['reason2']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
            ...
            return Redirect()->back()->with($notification);
		   		   ...
		   		   $image=$request->reason3;
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(1920,1080)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
                $data['reason3']='public/ads/'.$image_one;   //   public/postimages/123123.jpg
                 DB::table('settings')->where('id',$id) ->update($data);
                 $notification=array(
                     'messege'=>'Successfully Settings Updated ',
                     'alert-type'=>'success'
